<x-sidebar>
  ...
  <div class="reserve_users_area w-75">
    ...
    <div class="reserve_users_area_container">
  ...
  <div class="search_area w-25 border">
    <div class="m-4 ">
      <div class="search_area_text mt-3">
        <p>検索</p>
        <input type="text" class="free_word" name="keyword" placeholder="キーワードを検索" form="userSearchRequest">
      </div>
      <div>
        <label>カテゴリ</label>
        <select class="search_area_box" form="userSearchRequest" name="category">
      ...
      <div>
        <label>並び替え</label>
        <select class="search_area_box" name="updown" form="userSearchRequest">
          <option value="ASC">昇順</option>
          <option value="DESC">降順</option>
        </select>
      </div>
      <div class="">
        <div class="d-flex search_conditions_box">
          <p class="mt-3 search_conditions"><span>検索条件の追加</span></p>
          <div class="search_conditions_triangle"></div>
        </div>
        <div class="search_conditions_inner">
          ...
          <div>
            <label>権限</label>
            <select name="role" form="userSearchRequest" class="engineer search_area_box">
